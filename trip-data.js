    ...
    days: [
      {
        ...
        items: [
          { id: "d1-wakeup", time: "05:00", badge: "起床", title: "起床", description: "" },
          { id: "d1-home-departure", time: "06:00", badge: "自宅出発", highlight: true, title: "自宅 出発", description: "" },
          { id: "d1-keisei-ueno", time: "06:20", badge: "京成線", highlight: true, title: "京成上野 発", description: "" },
          ...
          { id: "d1-07", time: "15:00", badge: "リムジンバス", highlight: true, title: "ミエンタイ・バスターミナル 発", description: "カントーへ向けて出発。所要時間：約2時間40分～3時間30分。運賃：165,000 VND（約1,000円）。" },
          { id: "d1-08", time: "18:00頃", badge: "カントー", title: "カントー到着", description: "市内無料送迎が利用できる場合は、ホテルまたはカントー中心部まで利用。無料送迎対象外の場合はGrabを利用。ホテルまで所要時間：15分" },
          { id: "d1-09", time: "18:30頃", badge: "ホテル", title: "ホテル到着・チェックイン", description: "De Rivé Homestayにチェックイン。" },
          { id: "d1-night-departure", time: "19:00", badge: "夜散策", title: "メコン川沿い散策", description: "ホテルを出発し、ニンキウ埠頭～Love Bridge周辺など夜のメコン川沿いを散策。" },
          { id: "d1-dinner", time: "20:00", badge: "夕食", title: "夕食@ナイトマーケット", description: "ナイトマーケットでは、生モノや回転の悪いお店は避ける。Nem Nướng Thanh Vânも候補。" },
          { id: "d1-hotel-return", time: "21:00", badge: "ホテル", title: "ホテル帰着", description: "翌朝04:30起床予定のため、22:00までには戻る。" },
          { id: "d1-sleep", time: "23:00", badge: "就寝", title: "就寝", description: "翌朝のカイラン水上マーケットに備えて休む。" },
        ]
      },
      {
